        ...
        <div className="relative z-10 px-6 py-20 md:py-28">
          <div className="max-w-3xl mx-auto text-center" data-aos="fade-up" data-aos-duration="1000">
            <h2 className="text-4xl md:text-5xl font-bold text-[#521212] mb-6">
              Start Your Journey with Quick Growth
            </h2>
            
            <p className="text-lg text-black/70 mb-10">
              Embark on a transformation journey into the future of innovation as you kickstart your exploration of 
              Power AI, where limitless possibilities await at every click and command.
            </p>
            
            <div className="flex flex-wrap justify-center gap-6">
              <Link to="" className="flex items-center gap-2 px-8 py-3 bg-black text-white rounded-full transition-all duration-300 hover:bg-black/90 hover:-translate-y-1 sheen">
                Get Started
